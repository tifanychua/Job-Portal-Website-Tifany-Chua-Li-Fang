...
@router.get("/edit-company-profile", response_class=HTMLResponse)
async def edit_company_profile(request: Request):
    ...
    if company_doc.exists:
        ...
        company = {"specialty_category_ids": []}
...
# =====================================================
def return_error(request, company_data, industries, categories, message):
    return templates.TemplateResponse(
        request=request,
        name="editCompanyProfile.html",
        context={
...
async def update_company_profile(
    ...
    db.collection("company").document(company_id).set(company_data, merge=True)
