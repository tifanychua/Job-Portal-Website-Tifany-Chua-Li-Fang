...
def test_delete_experience_success(client):
    ...
    response = client.post(f"/delete-experience/{document_id}", follow_redirects=False)
...
def test_delete_invalid_experience(client):
    ...
    response = client.post("/delete-experience/INVALID_DOCUMENT_ID", follow_redirects=False)
...
def delete_record(client, context):
    ...
    context.response = client.post(
        f"/delete-experience/{context.document_id}", follow_redirects=False
    )
