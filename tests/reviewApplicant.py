...
def test_review_applicant_success(client):
    ...
    print(
        "✅ Acceptance Test Passed: Employer marked the application as Reviewed successfully."
    )
...
def test_applicant_status_updated(client):
    ...
    print(
        "✅ Acceptance Test Passed: Applicant status updated to Reviewed successfully."
    )
...
def test_reviewed_saved_database():
    ...
    print(
        "✅ Acceptance Test Passed: Reviewed applicant status saved in database."
    )
...
def verify_reviewed(context):
    ...
    print(
        "✅ Scenario Passed: Application status updated to Reviewed."
    )
...
def verify_saved(context):
    ...
    print(
        "✅ Scenario Passed: Reviewed application status saved in database."
    )