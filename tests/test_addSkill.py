...
def skill_validation(context):
    ...
    assert (
        "Skill" in response.text
        or "skill_id" in response.text
        or "Select Skill" in response.text
    )
...
def invalid_skill_message(context):
    ...
    assert (
        "Invalid Skill" in response.text
        or "Skill does not exist" in response.text
    )
