Feature: Decline Interview Notification
    As an Employer
    I want to receive an email notification when a job seeker declines an interview invitation
    So that I can take appropriate action, such as considering other candidates for the position.
