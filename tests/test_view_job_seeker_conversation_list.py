...
def insert_test_data():
    ...
    db.collection("company").document(
        "C000001"
    ).set(
        {
...
@given(
    "the job seeker is logged in and has existing conversations with employers"
)
...
@given(
    "the job seeker is viewing the conversation list"
)
...
@given(
    "the job seeker has no conversations with employers"
)
...
@when(
    "the job seeker opens the Messages page"
)
...
@then(
    "the system should display the list of conversations with employers"
)
...
@then(
    "the system should display the latest message and conversation details"
)
...
@then(
    'the system should display a "No conversations available" message'
)
